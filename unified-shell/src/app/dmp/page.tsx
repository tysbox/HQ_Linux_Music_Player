...
// Inject 3001 original Tailwind v3 CSS at runtime (Head-based injection
// is not reliable in App Router for non-root layouts).
if (typeof document !== 'undefined') {
  const id = 'dmp-original-css'
  if (!document.getElementById(id)) {
    const link = document.createElement('link')
    link.id = id
    link.rel = 'stylesheet'
    link.href = '/dmp-css/dmp-original.css'
